...
/**
 * @file
 * Lagoobernetes Drupal 8 development environment configuration file.
 *
...
if (getenv('LAGOOBERNETES_PRODUCTION_URL')) {
  $config['stage_file_proxy.settings']['origin'] = getenv('LAGOOBERNETES_PRODUCTION_URL');
}
